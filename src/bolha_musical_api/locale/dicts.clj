...
(def dicts
  {:en              {:enter-latitude              "Enter latitude"
                     ...
                     :fail-to-get-out-the-bubble  "I couldn't get out of the bubble. Please try again later"
                     :done                        "Done !"
   ...
   :pt-br           {:enter-latitude              "Informe a latitude"
                     ...
                     :fail-to-get-out-the-bubble  "Não consegui sair da bolha. Por favor, tente novamente mais tarde"
                     :done                        "Feito !"
